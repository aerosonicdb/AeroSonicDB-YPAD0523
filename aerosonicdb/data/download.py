...
def download(target_path=download_path):
    ...
    audio_zip = 'https://zenodo.org/record/10215080/files/audio.zip'
    env_audio_zip = 'https://zenodo.org/record/10215080/files/env_audio.zip'
    sample_meta_csv = 'https://zenodo.org/record/10215080/files/sample_meta.csv'
    aircraft_meta_csv = 'https://zenodo.org/record/10215080/files/aircraft_meta.csv'
    aircraft_meta_json = 'https://zenodo.org/record/10215080/files/aircraft_meta.json'
    locations_json = 'https://zenodo.org/record/10215080/files/locations.json'
    env_map_csv = 'https://zenodo.org/record/10215080/files/environment_class_mappings.csv'
    raw_env_map = 'https://zenodo.org/record/10215080/files/environment_mappings_raw.csv'
    license_txt = 'https://zenodo.org/record/10215080/files/LICENSE.txt'
    readme_md = 'https://zenodo.org/record/10215080/files/README.md'
    ...
    if not os.path.exists(target_path):
        ...
        urllib.request.urlretrieve(raw_env_map, os.path.join(target_path, 'environment_mappings_raw.csv'))
